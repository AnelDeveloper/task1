...
<br><br>
<input placeholder="confirmpassword" type="confirmpassword"  name="confirmpassword" id="phonenumber"  ></input>
<br><br>
...
<input type="submit"  name="register" id="button" value="Regist Truck user ">
